...
//         let methodChannel = FlutterMethodChannel(name: "next_ble_method", binaryMessenger: registrar.messenger())
//         registrar.addMethodCallDelegate(plugin, channel: methodChannel)
//         FlutterEventChannel(name: "next_ble_status", binaryMessenger: registrar.messenger())
//             .setStreamHandler(plugin.statusStreamHandler)
//         FlutterEventChannel(name: "next_ble_scan", binaryMessenger: registrar.messenger())
//             .setStreamHandler(plugin.scanStreamHandler)
//         FlutterEventChannel(name: "next_ble_connected_device", binaryMessenger: registrar.messenger())
//             .setStreamHandler(plugin.connectedDeviceStreamHandler)
//         FlutterEventChannel(name: "next_ble_char_update", binaryMessenger: registrar.messenger())
