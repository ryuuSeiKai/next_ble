...
class NextBleMobilePlatform extends NextBlePlatform {
  NextBleMobilePlatform({
...
class NextBleMobilePlatformFactory {
  ...
  NextBleMobilePlatform create() {
    ...
    const scanEventChannel = EventChannel("next_ble_scan");
    const bleStatusChannel = EventChannel("next_ble_status");
